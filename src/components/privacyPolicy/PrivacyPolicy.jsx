          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
              <p className="text-gray-700 space-y-2">
                ...
                <span className="block"><strong>Contact:</strong> <a href="mailto:support@printsbasket.com" className="text-blue-600 underline hover:text-blue-700">support@printsbasket.com</a></span>
              </p>
